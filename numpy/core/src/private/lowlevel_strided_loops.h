...
{
    const npy_intp offset = (size_t)addr % alignment;
 ...
 * of size 'esize' peeled by 'peel' and blocking to
 ...
 * npy_intp peel = npy_blocked_peel(v, esize, 16, n);
...
{
    return (nvals - peel - (nvals - peel) % (vsz / esize));
}
